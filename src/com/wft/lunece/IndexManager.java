...
public class IndexManager{
    ...
    private static String INDEX_DIR = "F:\\tomcat_test\\tomcat7.0.10_server\\userfiles\\uploads\\luceneIndex";
    private static String DDL_DIR = "F:\\tomcat_test\\tomcat7.0.10_server\\userfiles\\uploads\\DDL";
    private static String DML_DIR = "F:\\tomcat_test\\tomcat7.0.10_server\\userfiles\\uploads\\DML";
    private static Analyzer analyzer = null;
    private static Directory directory = null;
    private static IndexWriter indexWriter = null;
    
    static{
    	DDL_DIR = UploadPathUtil.getPath(UploadPathUtil.DDL);
    	DML_DIR = UploadPathUtil.getPath(UploadPathUtil.DML);
    	INDEX_DIR = UploadPathUtil.getPath("luceneIndex");
    	System.out.println("DDL_DIR:"+DDL_DIR);
    	System.out.println("DML_DIR:"+DML_DIR);
    ...
    public static void main(String[] args){
        ...
        createIndex();
        searchIndex("CMS_DEPT_MERGE_ACCOUNT");
    }
    ...
    public static boolean isTxtFile(String fileName) {
        if (fileName.lastIndexOf(".txt") > 0) {
            return true;
        }else if (fileName.lastIndexOf(".sql") > 0) {
            return true;
